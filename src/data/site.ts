...
export const nav = [
  ...
  { label: "Portefólio", to: "/portfolio" as const },
  { label: "Sobre", to: "/sobre" as const },
  { label: "VinilArt Sport", to: "/#vinilart-sport" as const, accent: true },
...
/** Estrutura preparada para substituição direta por trabalhos reais. */
export const portfolio: PortfolioItem[] = [
  { id: "p01", category: "Viaturas", image: "Viatura personalizada — vista lateral", ratio: "4 / 5", tone: "cyan" },
  { id: "p02", category: "Montras", image: "Montra comercial decorada", ratio: "4 / 3", tone: "magenta" },
  { id: "p03", category: "Logotipos 3D", image: "Logotipo 3D em receção", ratio: "1 / 1", tone: "yellow" },
  { id: "p04", category: "Interiores", image: "Espaço interior com aplicação gráfica", ratio: "16 / 10", tone: "cyan" },
  { id: "p05", category: "Estampagem", image: "Vestuário personalizado", ratio: "4 / 5", tone: "magenta" },
  { id: "p06", category: "Impressão", image: "Impressão de grande formato", ratio: "4 / 3", tone: "neutral" },
  { id: "p07", category: "Brindes", image: "Conjunto de brindes personalizados", ratio: "1 / 1", tone: "yellow" },
  { id: "p08", category: "Viaturas", image: "Frota de viaturas personalizada", ratio: "16 / 10", tone: "magenta" },
  { id: "p09", category: "Montras", image: "Vinil de corte em vidro", ratio: "1 / 1", tone: "cyan" },
  { id: "p10", category: "Interiores", image: "Sinalética interior", ratio: "4 / 5", tone: "yellow" },
  { id: "p11", category: "Estampagem", image: "Equipamento desportivo estampado", ratio: "4 / 3", tone: "cyan" },
  { id: "p12", category: "Logotipos 3D", image: "Letras tridimensionais em fachada", ratio: "16 / 10", tone: "magenta" },
];

export const processSteps = [
  { n: "01", title: "Ideia", text: "Percebemos o objetivo, contexto e resultado pretendido." },
  { n: "02", title: "Criação", text: "Desenvolvemos a solução visual mais adequada ao projeto." },
  { n: "03", title: "Produção", text: "Preparamos e executamos o trabalho com atenção ao detalhe." },
  { n: "04", title: "Aplicação", text: "Levamos a solução final ao espaço, produto ou suporte definido." },
];
...
export const mapEmbedUrl =
  "https://www.openstreetmap.org/export/embed.html?bbox=-9.3210%2C38.6840%2C-9.2950%2C38.6980&layer=mapnik";
